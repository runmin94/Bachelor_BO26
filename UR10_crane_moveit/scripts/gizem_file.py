...
def movegroup_init():
	...
	arm_group = moveit_commander.MoveGroupCommander("UR10_group")
	arm_group.set_named_target("tool_change_pose")
...
def main():    
    try:
        ...
        cartesian_control(arm_group, robot_init, GOAL_POSE)
        wpose = arm_group.get_current_pose().pose
        print "wpose:", wpose
        print "Enter x_val"
        ...
        cartesian_control(arm_group, robot_init, GOAL_POSE, x_val, y_val, z_val)
